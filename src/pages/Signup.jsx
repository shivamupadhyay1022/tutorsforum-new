        ...
        <div className="space-y-4">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex gap-4 justify-between" >
              <button className={`rounded-xl p-2 border-2 border-gray-700 ${choice == "Tutor" ? " bg-gray-700 text-white": ""}`}  onClick={()=> setChoice("Tutor")} >
                Tutor
              </button>
              <button className={`rounded-xl p-2 border-2 border-gray-700 ${choice == "Student" ? " bg-gray-700 text-white": ""}`}  onClick={()=> setChoice("Student")} >
                Student
              </button>
            </div>
          </div>
