...
function Home() {
  ...
  const organizationSchema = {
    ...
    "@type": "Organization",
    "name": "Tutors Forum",
    "url": "https://tutorsforum.in",
    "logo": "https://tutorsforum.in/tficon.png"
  };
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://tutorsforum.in/search?search={search_term_string}",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#ffded5]">
      <Helmet>
        <title>Tutors Forum - Find Your Perfect Tutor</title>
        <meta name="description" content="Connect with expert tutors who can help you master any subject and achieve your academic goals." />
        ...
        <section className="pt-24 flex flex-col items-center pb-4 px-4">
          <div className="w-full grid grid-cols-1  justify-center items-center mx-auto text-center">
            ...
            <div className="  flex w-full justify-center">
              <div className="flex flex-row min-w-[50vw] justify-self-center justify-between px-6 items-center  h-12 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full shadow-sm focus:ring-2 focus:ring-peach-100 focus:border-transparent">
                <svg
